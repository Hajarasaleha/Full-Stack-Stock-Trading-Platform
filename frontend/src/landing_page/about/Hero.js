    ...
    return (
        <div className='container mb-5'>
            <div className='row text-center mt-5 mb-5' style={{ color: "#424242" }}>
                <h3 className='fs-3'>We pioneered the discount broking model in India.<br />
                    Now, we are breaking ground with our technology.</h3>
            </div>
            <hr />
            <div className='row text-muted text-small'>
                <div className='col-6 ' style={{ paddingLeft: "100px", fontSize: "1.1em" }}>
                ...
                <div className='col-6 ml-5' style={{ paddingRight: "100px", fontSize: "1.1em" }}>
